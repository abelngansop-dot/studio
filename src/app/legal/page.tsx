                ...
                <TabsContent value="terms">
                    <Card>
                        ...
                        <CardContent className="space-y-4 prose max-w-none">
                            <p>Bienvenue sur Inoublevent. En utilisant nos services, vous acceptez les présentes conditions. Veuillez les lire attentivement.</p>
                            ...
                            <h2>2. Votre Compte Inoublevent</h2>
                            ...
                            <p>Tout le contenu présent sur la plateforme (textes, images, logos) est la propriété exclusive d'Inoublevent et est protégé par les lois sur la propriété intellectuelle.</p>
                ...
                <TabsContent value="privacy">
                     <Card>
                        ...
                        <CardContent className="space-y-4 prose max-w-none">
                            ...
                            <p>Nous ne partageons pas vos informations personnelles avec des entreprises, des organisations ou des personnes en dehors de Inoublevent, sauf si cela est nécessaire pour répondre à votre demande de service (par exemple, partager vos besoins avec un prestataire de service).</p>
                            
                             <h2>4. Sécurité des informations</h2>
                            <p>Nous travaillons dur pour protéger Inoublevent et nos utilisateurs contre tout accès non autorisé ou toute modification, divulgation ou destruction non autorisée des informations que nous détenons.</p>
